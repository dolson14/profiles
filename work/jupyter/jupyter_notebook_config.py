...
c.NotebookApp.notebook_dir = '/Users/dolson/research'
...
## post save model
#  based on idea from J. Whitmore, OSCON 2015
#  save notebooks in html and python in addition to notebook format
#import os
#from subprocess import check_call
#def post_save(model, os_path, contents_manager):
#    """post-save hook for converting notebooks to .py and .html files"""
#    if model['type'] != 'notebook':
#        return # This should only be done when in the notebook environment
